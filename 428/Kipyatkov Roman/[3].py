# -*- coding: utf-8 -*-
"""
Created on Thu May 25 20:54:45 2023
...
#Визуальная часть поискав глубину(Аватар помечен "А", путь до ключа точками, ключ - *)
for i in visited:
    if i != Key:
        maze_visual[i[0]][i[1]] = '.'
...
def A_star(graph, start, end):
    #Функция чекает расстояние от текущей до конечной
