...
if success:
    ...
    print("Не удалось установить ключ")
...
if dfs_path_start_to_key:
    print("Кратчайшее расстояние от входа до ключа (поиск в глубину):")
    print("Расстояние:", len(dfs_path_start_to_key))
    for position in dfs_path_start_to_key:
        print(position)
else:
    print("Направление от входа до ключа не найдено (поиск в глубину).")
...
if a_star_path_key_to_end:
    print("Кратчайшее расстояние от ключа до выхода (A*):")
    print("Расстояние:", len(a_star_path_key_to_end))
    for position in a_star_path_key_to_end:
        print(position)
else:
    print("Направление от ключа до выхода не найдено (A*).")
...
if dfs_path_start_to_key:
    ...
    marked_dfs_path_start_to_key = maze

if a_star_path_key_to_end:
    marked_a_star_path_key_to_end = mark_path(maze, a_star_path_key_to_end, "+")
else:
    marked_a_star_path_key_to_end = maze


marked_combined_maze_file = "labirint-f.txt"
...
print("Файл с помеченным путем (поиск в глубину + A*):labirint-f.txt")
