# начальные данные
fio = "Шеронов Александр Андреевич"
day = "3"
month = "апрель"
year = "2004"
...
family = ["Светлана", "Андрей", "Кирилл", "Павел", "Надежда", "Павел", "Ольга", "Полина", "Дарья",
...
number_of_actek = (3 + 4**2 + 2004) % 21 + 1
