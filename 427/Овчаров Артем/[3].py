import sys
import numpy as np
# Выполнили Овчаров и Любимов
print('\tВыполнили Овчаров и Любимов')


sys.setrecursionlimit(9000) # уменьшили лабиринт и увеличили стек, так как рекурсия упералась в потолок
