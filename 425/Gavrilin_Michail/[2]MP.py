...
# 42000 ðàçíûõ òî÷êè êîìïëåêñíîé ïëîñêîñòè
birth_day = 2
birth_month = 12
...
#[7, 12, 8, 9] 
#2 - bubble sort, ñîðòèðîâêà ïóçûðüêîì + íàòóðàëüíûå
#7 - Gnome sort, ãíîìüÿ ñîðòèðîâêà + èç êíèãè
#8 - selection sort, ñîðòèðîâêà âûáîðîì + êîìïëåêñíûå
#10 - Quicksort, áûñòðàÿ ñîðòèðîâêà + öåëûå
