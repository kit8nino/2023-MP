...
start_coord = (0, 1)
end_coord = (599, 798)
print("Вход", start_coord)
print("Выход", end_coord)
...
print("Ключ:", key_is_here)

greedy_path = greedy_search(maze, start_coord, key_is_here)
if greedy_path:
    print("Путь от входа до ключа", len(greedy_path))
...
if a_star_path:
    print("Путь от ключа до выхода", len(a_star_path))
